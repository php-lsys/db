...
use LSYS\Config;
class Database implements Config,\Serializable{
	protected $_name;
	...
	public function serialize () {
	    return serialize(array($this->_name,$this->_db,$this->_table));
	}
	/**
	 * {@inheritDoc}
	...
	public function unserialize ($serialized) {
	    list($this->_name,$this->_db,$this->_table)=unserialize($serialized);
	    $this->__construct($this->_name,$this->_db,$this->_table);
	}
}
